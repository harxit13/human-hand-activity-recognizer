...
export class GestureInterpreter {
  ...
  interpret(results) {
    ...
    // Debug: log results structure on first detection
    if (!results) {
      console.warn('GestureInterpreter.interpret: results is null/undefined');
      return output;
    }

    if (!results.multiHandLandmarks) {
      console.warn('GestureInterpreter.interpret: results.multiHandLandmarks is missing. Available keys:', Object.keys(results));
      this.lastPinchDistance = null;
      this.lastHandAngle = null;
      return output;
    }
