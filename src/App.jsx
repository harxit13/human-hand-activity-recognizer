...
function App() {
  ...
  const onResults = useCallback((results) => {
    ...
    if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
      console.log('Hands detected:', results.multiHandLandmarks.length, 'Primary gesture:', primary.gesture);
    }
  ...
  return (
    <div className="app-container">
      {cameraVisible && (
        <>
          <CameraView
            ...
            onResults={onResults}
          />
          {objectDetectionEnabled && <ObjectDetectionOverlay videoRef={videoRef} />}
        </>
      )}
      ...
      <ControlPanel
        ...
        onToggleObjectDetection={() => setObjectDetectionEnabled(!objectDetectionEnabled)}
